...
(defn parsed-word->word [parsed-word]
  ...
  (let [selected-opt (first (:options parsed-word))
        ...
        word (or ({"ess.e" "esse" "sc.is" "scīs" "laud.ate" "laudāte"
                   ...
                   "fabric.atis" "fabricātus" "possid.ebatur" "possidēbātur" "lac.um" "lacum" "clam.ate" "clāmāte" "modic.um" "modicum" "prophet.am" "prophētam" "sicer.am" "siceram" "av.um" "avum" "irat.us" "īrātus" "peper.it" "peperit" "compert.um" "compertum" "t.ui" "tuī" "ablat.a" "ablāta" "dux.ere" "dūxēre" "utr.um" "utrum" "veni.te" "venīte" "narr.ate" "nārrātē"
                   } word) word)]
    word))
